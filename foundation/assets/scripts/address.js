...
$('#checkaddress').on('submit', function(e){
    ...
    $.ajax({
        ...
        success: function (resultHtml) {
			...
			var header="<h4>Address:</h4>Once again, thank you for donating your PiggyCoins.<br>You have donated ";
            $('#donewithcheck').html( header+resultHtml+" PiggyCoins as of now.").fadeIn('slow');
          }
    });
